...
# Positions for DFEC Arrangement
x_dest = [2.3, 2.5, 1.6, 1.30, 1.30, 1, 1.0, 1, 2, 2.3, 2.6, 3, 3.3, 3.6, 4, 4, 4.0, 4.6, 4.6, 3.6, 3.3, 3.3, 3.0, 3, 2]
y_dest = [2.5, 2.5, 2.5, 2.75, 2.25, 2, 2.5, 3, 3, 3.0, 3.0, 3, 3.0, 3,0, 3, 2, 2.5, 2.0, 3.0, 2.0, 2.5, 2.0, 2.5, 2, 2]
