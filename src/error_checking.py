...
def measure_error(bots: list, num_samples=5, sample_period=10):
    logger.info("Collecting ", num_samples, " taken every ", sample_period, " seconds")
    for Cycle in range(0, num_samples):
        ...
        logger.debug("Finished sample: ", Cycle + 1)
    ...
    logger.info("CSV created with filename: ", filename)
