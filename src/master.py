...
# an alphabet-list of letter-arrays holding coordinate-arrays
# idea for later: add third coordinate to simulate weight of position so that only the important positions must be filled when low on number of robots
# this is built for a coordinate system of 4 by 4 inch squares or 10 x 10 cm square units, letters are 7x8units
def alphabet(letter):
